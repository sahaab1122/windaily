...
class AppNavigator extends React.Component {
  ...
  homeStack = () => {
    return (
      ...
      >
        ...
        <Stack.Screen name="Tier" component={Tier} options={{ title: '' }} />
        <Stack.Screen name='Setting' component={this.settingStack} />
  ...
  MyTabBar = ({ state, descriptors, navigation }) => {
    ...
    return (
      <View style={{ flexDirection: 'row', height: 80, paddingVertical: getStatusBarHeight() / 4, backgroundColor: '#fbfbfb', justifyContent: 'space-evenly', }}>
