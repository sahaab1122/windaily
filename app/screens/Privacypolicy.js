            ...
            <LinearGradient colors={['#04a4df', '#fff']} style={{ backgroundColor: "#04a4df", width: "100%", height: "100%", justifyContent: "space-evenly" }}>
                <ScrollView showsVerticalScrollIndicator={false} style={{ paddingHorizontal: 20 }}>
                    ...
                    <Text style={{ fontSize: 20, textAlign: "left", paddingVertical: 30 }}>
                        ...
                        downloaded by You on any electronic device, named Win Daily{"\n"}
                        • Company (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to Win Daily.{"\n"}
                        ...
                        the Service.{"\n"}
                        • Usage Data refers to data collected automatically, either generated using
                        ...
                        Media Service, we may collect Personal data that is already associated with your ThirdParty Social Media Service's account, such as your name, your email address, your
                        ...
                        by all users and may be publicly distributed outside. If You interact with other
                        ...
                        pictures, and description of Your activity. Similarly, other users will be able to
                        ...
                        • By email: windailybiz@gmail.com{"\n"}
                    </Text>
